...
DEPLOY_NOTIFY_PROMPT = (
    ...
    "Step 3 — Pick the message template.\n"
    "Let TICKET_URL = https://cognota.atlassian.net/browse/<ticket key>\n"
    "Let PARENT_URL = https://cognota.atlassian.net/browse/<parent key>\n"
    "Rules in order:\n"
    "  a. If ticket issuetype is 'Bug', 'Defect', or 'Hotfix' →\n"
    "     subject = \"this bug fix\", link = TICKET_URL\n"
    "  b. Else if parent issuetype is 'Story' →\n"
    "     subject = \"this story\", link = PARENT_URL\n"
    "  c. Otherwise →\n"
    "     subject = \"this story\", link = TICKET_URL\n\n"
